		...
		<div id="contents">
				...
				<div class="SP_layoutFix">
				   ...
				   <div id="floating">
					...
					<form id="detailForm" name="detailForm"
									...
									<table border="1" summary="" class="SP_tableSt01_isThAndTd">
										...
										<tbody>
											<tr>
												...
												<td><span>${order.ordid}</span>
												</td>
											</tr>
											<tr>
												<th scope="row">주문일자</th>
												<td> <fmt:formatDate value="${order.ordorderdate}" pattern="yyyy-MM-dd" /></td>
											</tr>
											<tr>
												<th scope="row">주문자</th>
												<td><span>${order.ordname}</span></td>
											</tr>
						...
						<strong class="txt14">
						  <fmt:formatNumber value="${order.ordtotalamount}" type="number" maxFractionDigits="0" /> 원						
						</strong> 
										...
										<tbody class="">
											<tr class="sum">
												...
												<td><strong class="txt14"> <fmt:formatNumber value="${order.ordcpndiscount + order.ordpdtdiscount}" type="number" maxFractionDigits="0" /> 원
												</strong></td>
											</tr>
											...
											<tr class="displaynone">
												...
												<td><span class="gSpace20"> <fmt:formatNumber value="${order.ordcpndiscount}" type="number" maxFractionDigits="0" /> 원
												</span>
												 <!-- <a href="#none"
											...
											<tr class="">
												...
												<td><span class="gSpace20"><fmt:formatNumber value="${order.ordpdtdiscount}" type="number" maxFractionDigits="0" /> 원
												</span> <a href="#none"
													class="btnNormal"
													onclick=>내역보기</a>
												</td>
									...
									<table border="1" summary="" class="SP_tableSt01_isThAndTd">
										...
										<tbody>
											...
											<tr class="">
												...
												<td><span><span>${order.ordpayoption}</span></span>
													<p>
											...
											<tfoot class="right">
											    <tr>
											        <td colspan="7">
											            ...
											            상품구매금액 
											            <strong>
											                <fmt:formatNumber value="${order.ordtotalamount - order.orddeliveryfee + order.ordcpndiscount + order.ordpdtdiscount}" type="number" pattern="#,##0" />원
											            </strong>
											            <span class="displaynone"> + 부가세 0</span> 
											            + 배송비 
											            <fmt:formatNumber value="${order.orddeliveryfee}" type="number" pattern="#,##0" />원
											            <span class="displaynone"> - 상품할인금액 </span>
											            <fmt:formatNumber value="${order.ordcpndiscount + order.ordpdtdiscount}" type="number" pattern="#,##0" />원
											            = 합계 : 
											            <strong class="txtEm gIndent10">
											                <span class="txt18">
											                    <fmt:formatNumber value="${order.ordtotalamount}" type="number" pattern="#,##0" />원
											                </span>
											            </strong>
											            <span class="displaynone"></span>
											        </td>
            ...
            <c:forEach var="details" items="${orderDetails}">
                <tr class="xans-record-">
                    ...
                    <td class="left">
                        <strong class="name">
                            <a href="/product/n-티니-네일/2089/category/160/" class="ec-product-name">${details.opdtname}</a>
                        </strong>
                        <div class="option "></div>
                        <p class="gBlank5 displaynone">무이자할부 상품</p>
                    </td>
                    <td>${details.opdtcount}</td>
                    
       <!-- 할인 및 금액 계산 -->
        <c:set var="dividedAmount" value="${details.opdtamount * details.opdtcount}" />
        <c:set var="dividedDCAmount" value="${details.opdtdcamount * details.opdtcount}" />
                    
                    <td class="right">
			            <!-- 총 금액 -->
			            <div class="discount">
			                <strong>
			                    <fmt:formatNumber value="${dividedAmount}" type="number" maxFractionDigits="0" />
			                </strong>
			            ...
			            <div>
			                <strong>
			                    <fmt:formatNumber value="${dividedDCAmount}" type="number" maxFractionDigits="0" />
			                </strong>
			                <div class="displaynone"></div>
			            </div>
			        </td>
			        ...
			        <!-- 배송정보 -->
			        <td>기본배송</td>
			        <td>${details.opdtstate}</td>
			        <td>${details.opdtrefund}</td>
			    </tr>
            </c:forEach>
									...
									<table border="1" summary="" class="SP_tableSt01_isThAndTd">
										...
										<tbody>
											<tr>
												...
												<th scope="row">총 결제금액</th>
												<td><span class="txtEm"><strong class="txt18">
												<fmt:formatNumber value="${order.ordtotalamount}" pattern="#,##0" />원
												</strong></span>
									...
									<table border="1" summary="" class="SP_tableSt01_isThAndTd">
										...
										<tbody
											...
											<tr class="xans-record-">
												...
												<td><strong><fmt:formatNumber value="${order.ordtotalamount - order.orddeliveryfee + order.ordcpndiscount + order.ordpdtdiscount}" type="number" pattern="#,##0" />원</strong>
													<p></p></td>
											</tr>
											<tr class="xans-record-">
												<th scope="row">배송비</th>
												<td><strong><fmt:formatNumber value="${order.orddeliveryfee}" type="number" pattern="#,##0" />원</strong>
													<p></p></td>
											</tr>
											<tr class="xans-record-">
											...
											<td>
											    <strong>
											        <fmt:formatNumber 
											            value="${order.ordtotalamount - (order.ordcpndiscount + order.ordpdtdiscount) + order.orddeliveryfee}" 
											            type="number" 
											            maxFractionDigits="0" 
											        />원
											    </strong>
									...
									<table border="1" summary="" class="SP_tableSt01_isThAndTd">
										...
										<tbody>
											...
											<tr class="">
												...
												<td><span>${order.ordzipcode}</span></td>
											</tr>
											<tr class="">
												<th scope="row">주소</th>
												<td><span>${order.ordaddress}</span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">도시</th>
												<td></td>
