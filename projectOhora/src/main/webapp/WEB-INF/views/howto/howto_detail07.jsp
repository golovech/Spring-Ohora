													...
													<div class="fr-view fr-view-article">
														...
														<p>
															...
															<a
																...
																<img
																src="${contextPath}/resources/images/howto_detail_image/howtouse_detail13.jpg"
																class="fr-fic fr-dib">
															</a><br>
														</p>
														<p>
															<img
																src="${contextPath}/resources/images/howto_detail_image/howtouse_detail14.jpg"
																class="fr-fic fr-dib">
														</p>
														<p>
															<img
																src="${contextPath}/resources/images/howto_detail_image/howtouse_detail15.jpg"
																class="fr-fic fr-dib">
														</p>
													</div>
												</div>
				...
				<div
					...
					<ul>
						...
						<li class="prev "><span>이전글</span><a
							href="${contextPath}/ohora/howto_detail04.jsp">젤네일팁 사용편</a></li>
						<li class="next "><span>다음글</span><a
							href="${contextPath}/ohora/howto_detail08.jsp">너리싱 네일 오일 사용법</a></li>
					</ul>
				</div>
			</div>
		</div>
