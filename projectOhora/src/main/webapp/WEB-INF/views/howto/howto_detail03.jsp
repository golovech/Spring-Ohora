				...
				<div class="SP_layoutFix">
					...
					<form id="BoardDelForm" name="" action="/exec/front/Board/del/13"
						...
						<input id="bdf_modify_url" name="bdf_modify_url"
							...
							value="/exec/front/Board/del/13" type="hidden"> <input
									...
									<tbody>
											...
											<td colspan="4">
												<div class="detail">
													...
													<div class="fr-view fr-view-article">
														<p>
															<img
																src="${contextPath}/resources/images/howto_detail_image/howtouse_detail01.jpg"
																class="fr-fic fr-dib">
														</p>
														<p>
															<a
																...
																<img
																src="${contextPath}/resources/images/howto_detail_image/howtouse_detail02.jpg"
																class="fr-fic fr-dib">
															</a><br>
														</p>
														<p>
															<img
																src="${contextPath}/resources/images/howto_detail_image/howtouse_detail03.jpg"
																class="fr-fic fr-dib">
														</p>
													</div>
												</div>
										...
										<tr class="displaynone ">
											...
											<td><input id="password" name="password" fw-filter=""
												...
												<span class="ec-base-help txtInfo">삭제하려면 비밀번호를 입력하세요.</span></td>
										</tr>
									</tbody>
								</table>
							</div>
				...
				<div
					...
					<ul>
						<li class="prev "><span>이전글</span><a
							href="${contextPath}/ohora/howto_detail01.jsp">VIP GIFT season
								4. 사용법</a></li>
						<li class="next "><span>다음글</span><a
							href="${contextPath}/ohora/howto_detail04.jsp">루즈스킨 리무버 사용편</a></li>
					</ul>
				</div>
