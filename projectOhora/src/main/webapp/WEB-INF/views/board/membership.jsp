	...
	<div id="SP_boardPageChk">
		<div class="SP_layoutFix">
			<div
				...
				<form id="BoardDelForm" name="" action="/exec/front/Board/del/3"
					method="post" target="_self" enctype="multipart/form-data">
					<input id="no" name="no" value="166365" type="hidden" /> <input
						id="bulletin_no" name="bulletin_no" value="155959" type="hidden" />
					<input id="board_no" name="board_no" value="3" type="hidden" /> <input
						id="member_id" name="member_id" value="ohoracs6" type="hidden" />
					<input id="list_url" name="list_url"
						value="/board/free/list.html?board_no=3" type="hidden" />
					<input id="bdf_modify_url" name="bdf_modify_url"
						...
						name="bdf_del_url" value="/exec/front/Board/del/3" type="hidden" />
						...
						<div class="ec-base-table typeWrite">
							<table border="1" summary=""
								...
								<tbody>
									<tr>
										<th scope="row">제목</th>
										<td colspan="3">ohora membership 오호라 멤버쉽 안내</td>
									</tr>
									<tr>
										<th scope="row">작성자</th>
										<td colspan="3"><span class="">ohora</span></td>
									</tr>
									<tr class="">
										...
										<td class="displaynone"><a href="#none" class="btnNormal"
											onclick="BOARD_READ.article_vote('/exec/front/Board/vote/3?no=166365&amp;return_url=%2Farticle%2Ffaq%2F3%2F166365%2F&amp;4a1d1ff4e816cd89f20332b9e94d84=400108819b1984f0c19805f6ac891273&amp;board_no=3');"><img
									...
									<tr class="displaynone">
										...
										<td><input id="password" name="password" fw-filter=""
											...
											<span class="ec-base-help txtInfo">수정
												및 삭제하려면 비밀번호를 입력하세요.</span></td>
									</tr>
									<tr>
										<td colspan="4">
												...
												<div class="fr-view fr-view-article">
													<p>
														<img
															...
															name="EC9DB4EBAFB8ECA7801.jpg" size="1000px/1496px"
															filesize="75,11 kB" error="" />
													</p>
													<p>
														<img
															src="https://ohora2019.cafe24.com/web/upload/NNEditor/20241029/EC9DB4EBAFB8ECA7802.jpg"
															class="fr-fic fr-dib" result="success"
															name="EC9DB4EBAFB8ECA7802.jpg" size="1000px/2936px"
															filesize="119,00 kB" error="" />
													</p>
													<p>
														<img
															src="https://ohora2019.cafe24.com/web/upload/NNEditor/20241029/EC9DB4EBAFB8ECA7803.jpg"
															class="fr-fic fr-dib" result="success"
															name="EC9DB4EBAFB8ECA7803.jpg" size="1000px/2218px"
															filesize="195,31 kB" error="" />
													</p>
												</div>
											</div>
										</td>
						...
						<div class="SP_submitBtn_wrap SP_submitBoardBtn_wrap">
							<div class="SP_submitBtn_left">
								<span class="displaynone"> <a href="#none" onclick=""
									class="SP_cm_btn SP_btn_gray_bd displaynone"></a>
									<a href="#none" onclick=""
									class="SP_cm_btn SP_btn_gray_bd admin displaynone"></a>
									<a href="#none" onclick="" class="SP_cm_btn SP_btn_gray_bd">스팸신고</a>
									<a href="#none" onclick="" class="SP_cm_btn SP_btn_gray_bd">스팸해제</a>
								</span> <a href="/projectOhora/ohora/notice.jsp"
			...
			<div
				...
				<form id="commentForm" name=""
					action="/exec/front/Board/CommentUpdate/3" method="post"
					target="_self" enctype="multipart/form-data" style="display: none">
					<input id="board_no" name="board_no" value="3" type="hidden" /> <input
						id="no" name="no" value="166365" type="hidden" /> <input
				...
				<form id="commentSecretForm" name=""
					action="/exec/front/Board/CommentSecret/3" method="post"
					target="_self" enctype="multipart/form-data" style="display: none">
					<input id="board_no" name="board_no" value="3" type="hidden" /> <input
						id="comment_no" name="comment_no" value="" type="hidden" /> <input
			...
			<div
				...
				<ul>
					<li class="prev displaynone"><span>이전글</span><a
						href="/article/faq/3/217049/"> </a></li>
					<li class="next"><span>다음글</span><a href="#empty">
							[종료][10/14~10/28] 오호라 보관함 증정 이벤트</a></li>
				</ul>
			</div>
