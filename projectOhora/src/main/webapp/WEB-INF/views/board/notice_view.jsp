								...
								<div class="SP_submitBtn_wrap SP_submitBoardBtn_wrap ">
									<div class="SP_submitBtn_left">
										<span class="displaynone"> <a href="#none" onclick=""
											...
											href="noticelist.do?currentPage=${ param.page }&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }"
						...
						<ul>
							<c:if test="${not empty previousPost}">
								<li class="prev"><span>이전글</span> <a
									href="noticeview.do?seq=${previousPost.seq}&page=${param.page}">${previousPost.title}</a>
								</li>
							</c:if>
							<c:if test="${not empty nextPost}">
								<li class="next"><span>다음글</span> <a
									href="noticeview.do?seq=${nextPost.seq}&page=${param.page}">${nextPost.title}</a>
								</li>
							</c:if>
						</ul>
					</div>
